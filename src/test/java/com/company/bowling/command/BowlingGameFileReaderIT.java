...
public class BowlingGameFileReaderIT {
    ...
    @Test
    public void givenAPerfectGameInputFileWhenExecuteItShouldPrintTheGameResultBoard() throws IOException {
        // given
        MultiPlayerBowlingGamePrinter printer = new MultiPlayerBowlingGameConsolePrinter();
        MultiPlayerBowlingGame game = new MultiPlayerTenPinBowlingGame();
        ...
        game = command.execute(resource.getPath());
        printer.print(game);
        // then
    ...
    @Test(expected = MalformedPlayerInputRoll.class)
